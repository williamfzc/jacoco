 ...
 *
 *******************************************************************************/
package org.jacoco.report.sxml;
...
import org.jacoco.report.internal.xml.SXMLCoverageWriter;
	...
	public IReportVisitor createVisitor(final OutputStream output)
		...
		class RootVisitor implements IReportVisitor {
			...
			public void visitBundle(final IBundleCoverage bundle,
				...
				SXMLCoverageWriter.writeBundle(bundle, report);
			}
